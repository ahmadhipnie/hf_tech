    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav  sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color: #23274D;">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#">
                ...
                <div class="sidebar-brand-text mx-3" style="white-space: nowrap; font-weight: bold;">
                    Admin HF-Tech
                </div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('admin.proyek') }}">
                    <i class="fas fa-chalkboard-teacher"></i>
            ...
            <footer class="sticky-footer">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; SMPN 5 Kupang Tengah</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
