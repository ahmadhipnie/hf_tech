...
<body class="index-page">
    ...
    <main class="main">
                                    ...
                                    @foreach ($proyek->tags as $tag)
                                        <span class="badge bg-light text-dark border me-1">
                                            <img src="https://cdn.jsdelivr.net/npm/simple-icons@v11/icons/{{ strtolower($tag->icon) }}.svg"
                                                ...
                                                style="vertical-align:middle; filter: brightness(0) invert(1);"> {{ $tag->nama_tag }}
                                        </span>
                                    @endforeach
                                </div>
                                <div class="mb-2">
                        ...
                        <div class="faq-container">
                            ...
                            <div class="faq-item" data-aos="fade-up" data-aos-delay="250">
                                ...
                                <div class="faq-content-wrapper">
                                    ...
                                    <div class="faq-content">
                                        <p>Ada. Maksimal 7x revisi minor (contoh: mengubah warna, tambahan fungsionalitas sederhana, dll.)</p>
                                    </div>
                                </div>
                                <i class="faq-toggle bi bi-chevron-down"></i>
                            </div><!-- End Faq item-->
                            ...
                            <div class="faq-item" data-aos="fade-up" data-aos-delay="300">
                                ...
                                <div class="faq-content-wrapper">
                                    ...
                                    <div class="faq-content">
                                        <p>Ya, kami berkomitmen menyelesaikan setiap proyek sesuai dengan kesepakatan. Jika ada kendala, kami akan komunikasikan langsung.</p>
                                    </div>
                                </div>
                                <i class="faq-toggle bi bi-chevron-down"></i>
                            </div><!-- End Faq item-->
                            ...
                            <div class="faq-item" data-aos="fade-up" data-aos-delay="350">
                                ...
                                <div class="faq-content-wrapper">
                                    ...
                                    <div class="faq-content">
                                        <p>Anda bisa langsung menghubungi kami via WhatsApp atau mengisi form pemesanan. Tim kami akan segera merespons dalam waktu 1x24 jam.</p>
                                    </div>
                                </div>
                                <i class="faq-toggle bi bi-chevron-down"></i>
                            </div><!-- End Faq item-->
        ...
        <section id="tiktok" class="tiktok section">
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <blockquote class="tiktok-embed" cite="https://www.tiktok.com/@hf.tech" data-unique-id="hf.tech" data-embed-type="creator" style="max-width: 780px; min-width: 288px;" > <section> <a target="_blank" href="https://www.tiktok.com/@hf.tech?refer=creator_embed">@hf.tech</a> </section> </blockquote> <script async src="https://www.tiktok.com/embed.js"></script>
                </div>
            </div>
            ...
            <div class="row gy-4">
                ...
                <div class="col-lg-4 col-md-12">
                    ...
                    <div class="social-links d-flex">
                        ...
                        <a href="https://www.instagram.com/hf_tech77?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw=="><i class="bi bi-instagram"></i></a>
